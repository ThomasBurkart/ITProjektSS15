...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "itprojektss15" because\n';
  ...
  $wnd.__gwt_activeModules['itprojektss15'] = {
    'moduleName' : 'itprojektss15',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/itprojektss15.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['itprojektss15'].superdevmode = true;

  var expectedSuffix = '/itprojektss15.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + itprojektss15 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:itprojektss15';
  var devModeSessionKey = '__gwtDevModeSession:itprojektss15';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/itprojektss15/itprojektss15.nocache.js';
  ...
  $wnd.__gwt_activeModules['itprojektss15'].canRedirect = true;
  $wnd.__gwt_activeModules['itprojektss15'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING itprojektss15';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/itprojektss15?user.agent=' + ua + '&_callback=' + callback;
