...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "reportgen" because\n';
  ...
  $wnd.__gwt_activeModules['reportgen'] = {
    'moduleName' : 'reportgen',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/reportgen.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['reportgen'].superdevmode = true;

  var expectedSuffix = '/reportgen.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + reportgen + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:reportgen';
  var devModeSessionKey = '__gwtDevModeSession:reportgen';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/reportgen/reportgen.nocache.js';
  ...
  $wnd.__gwt_activeModules['reportgen'].canRedirect = true;
  $wnd.__gwt_activeModules['reportgen'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/reportgen?user.agent=' + ua + '&_callback=' + callback;
