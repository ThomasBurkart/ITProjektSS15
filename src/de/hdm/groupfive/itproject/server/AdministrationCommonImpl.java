...
public class AdministrationCommonImpl extends RemoteServiceServlet implements
	 ...
	 * @param element Bauteil das ver�ndert werden soll
	 * @return Das ge�nderte Bauteil wird an den Bauteil-Mapper (ElementMapper) �bergeben
	 */
	@Override
	 ...
	 * @param element Bauteil das gel�scht werden soll
	 * @return das zu l�schende Bauteil wird an den Bauteil-Mapper (ElementMapper) �bergeben zum l�schen
	 */
	@Override
	...
	*/
	 ...
	 * @return Die bearbeitete Baugruppe wird an den Baugruppen-Mapper (ModuleMapper) �bergeben
	 */
	@Override
	...
	*/
	 ...
	 * @param module Baugruppe die gel�scht werden soll
	 * @return die zul�schende Baugruppe wird an den Baugruppen-Mapper (ModuleMapper) �bergeben zum l�schen
	 */
	@Override
	 ...
	 * @param module Baurgruppe der St�ckliste
	 */
