...
public class DBConnection {
	...
	/**
	 * Diese statische Methode kann aufgrufen werden durch
	 * <code>DBConnection.closeConnection()</code>. Sie löst eine bestehende
	 * Verbindung zur Datenbank auf.
	 * 
	 * @throws RuntimeException
	 *             - beim "kappen" der DB- Verbindung kann ein Fehler entstehen,
	 *             welcher mittelbar an die aufrufende Methode weitergeleitet
	 *             wird
	 * @throws SQLException
	 */

	public static void closeConnection() throws RuntimeException, SQLException {
		if (con != null && (!con.isClosed())) {
			try {
				...
				throw new RuntimeException(
						"Fehler beim Trennen der DB-Verbindung aufgetreten:"
								+ ex.getMessage());
			}
		}
