...
public class LoggingDialog {
	...
	public static DialogBox getDialogBox() {
		if (dialog == null) {
			...
			memberGrid.setHTML(3, 0, "Timo Fesseler");
			memberGrid.setHTML(3, 1, "28001");
			memberGrid.setHTML(4, 0, "Thomas Burkart");
			memberGrid.setHTML(4, 1, "27961");
